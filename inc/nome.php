...
include("menus.php");
 ...
 <div class="container-fluid">
   ...
   <div class="row">
            <div class="col-md-6"> <h3><i class="fa fa-server" aria-hidden="true"></i>&nbsp;<?=get_lang('Menu_nome');?></h3>
            </div>
   </div>
    </div>
 <div class="row">
  <div class="col-md-12">
    ...
    <div class="panel-heading">
      <i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;<?=get_lang('Nome_title');?>
    </div>
    <div class="panel-body">
      <table id="table_nome" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
          <thead>
            <tr>
