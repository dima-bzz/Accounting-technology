...
include("menus.php");
 ...
 <div class="container-fluid">
   ...
   <div class="row">
            <div class="col-md-6"> <h3><i class="fa fa-history" aria-hidden="true"></i>&nbsp;<?=get_lang('Menu_history_moving');?></h3>
            </div>
   </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="panel-heading">
          <i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;<?=get_lang('Moving_history_title');?>
