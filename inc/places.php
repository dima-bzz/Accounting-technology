...
include("menus.php");
 ...
 <div class="container-fluid">
   ...
   <div class="row">
            <div class="col-md-6"> <h3><i class="fa fa-users" aria-hidden="true"></i>&nbsp;<?=get_lang('Menu_places');?></h3>
            </div>
   </div>
    </div>
 <div class="row">
  <div class="col-md-12">
    ...
    <div class="panel-heading">
      <i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;<?=get_lang('Places_title');?>
 ...
 <div class="panel panel-default">
 <div class="panel-heading">
   <i class="fa fa-male" aria-hidden="true"></i>&nbsp;<?=get_lang('Places_sub_title');?>
